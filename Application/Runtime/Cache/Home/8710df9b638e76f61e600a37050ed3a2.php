...
<div class="left">
		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="nav navbar-nav">
		        ...
		        <li><a href=<?php echo U('story/likeToStory',['uid'=>$currentUserInform['id']]);?>>
				<?php if($userInform['id'] == $currentUserInform['id']): ?>我关注的 
			    <?php else: ?>
				他关注的<?php endif; ?>
		        </a></li>
		      	<li class="active"><a href=<?php echo U('story/likeBeUsers',['uid'=>$currentUserInform['id']]);?>>
	...
	<?php if($articles == 0): ?><div class="articleEmpty">没有可显示的新关注</div><?php endif; ?>
	<?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><div class='users belike'>
			...
			<div class='drop'>
			<a href="#" data-idlike=<?php echo ($user["id"]); ?> data-belikeid=<?php echo ($currentUserInform["id"]); ?> class='glyphicon glyphicon-chevron-down dropmenu' ></a>
			</div>
