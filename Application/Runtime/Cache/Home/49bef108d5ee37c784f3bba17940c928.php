...
<div class="container">
		...
		<div class="left">
				  ...
				  <div class="container-fluid">
				    ...
				    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				      <ul class="nav navbar-nav">
				        <li class="active"><a href=<?php echo U('story/homestory',['uid'=>$currentUserInform['id']]);?>>故事<span class="sr-only">(current)</span></a></li>
			...
			<?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i;?><article>
					...
					<div class="main">
						<div class="tags">
							<?php if(is_array($article['tags'])): $i = 0; $__LIST__ = $article['tags'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag): $mod = ($i % 2 );++$i;?><a href="#"><?php echo ($tag["name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
						</div> 
