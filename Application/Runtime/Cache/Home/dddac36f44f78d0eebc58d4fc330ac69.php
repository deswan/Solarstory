		...
		<div class="left">
			...
			<nav style="text-align: center">
			  <ul class="pagination">
				  ...
				  <li>
					  <a href=<?php echo U('story/indextag',['tagid'=>$tagid,'page'=>$currentpage+1]);?> aria-label="Previous">
				  ...
				  <li>
					  <a href=<?php echo U('story/indextag',['tagid'=>$tagid,'page'=>$currentpage+1]);?> aria-label="Next">
