...
<div class="container">
		...
		<div class='leftnav'>
			<ul>
				...
				<?php if(!empty($userInform)): ?><a href=<?php echo U('story/homestory',['uid'=>$userInform['id']]);?>><li>故事<i class="fa fa-pencil"></i></li></a>
					...
					<a href=<?php echo U('story/commentout');?> class='active'><li>评论<i class="glyphicon glyphicon-comment"></i></li></a>
		...
		<div class="left">
			...
			<div class="homebanner">
				<div class="btn-group btn-group-justified" role="group" aria-label="...">
					<div class="btn-group" role="group" aria-label="...">
						<a href=<?php echo U('story/commentout');?> class="active commentbtn btn btn-default" type="button" role='button'>
							发出的评论
						</a>
					</div>
					<div  class="btn-group" role="group" aria-label="...">
						<a href=<?php echo U('story/commentin');?> class="commentbtn btn btn-default" type="button" role='button'>
							收到的评论
						</a>
					</div>
				</div>
			...
			<?php if(is_array($comments)): $i = 0; $__LIST__ = $comments;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$comment): $mod = ($i % 2 );++$i;?><div class=mycomment>
					...
					<div class="right">
						...
						<p class=totext>评论<?php echo ($comment["tousername"]); ?>的故事：<?php echo ($comment["articletext"]); ?></p>
					</div>
					<div class='clean'></div>
			...
			<nav style="text-align: center">
				<ul class="pagination">
					...
					<li>
						<a href=<?php echo U('story/commentout',['page'=>$currentpage-1]);?> aria-label="Previous">
					...
					>
					<a href=
							   <?php echo U('story/commentout',['page'=>$i]);?>
						>
						<?php echo $i ?>
					</a>
					</li>
					...
					<li>
						<a href=<?php echo U('story/commentout',['page'=>$currentpage+1]);?> aria-label="Next">
